...
## Hints
- You can find the relevant formulae on [Wikipedia](https://en.wikipedia.org/wiki/Conversion_of_units_of_tempte two functions that convert temperatures from Fahrenheit to Celsius, anderature).
